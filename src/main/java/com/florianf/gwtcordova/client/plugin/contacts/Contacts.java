...
public class Contacts {
	...
	public static native void find(JsArrayString fields, Function<Void, Contact[]> success, Function<Void, ContactError> error, ContactOptions contactOptions);
	...
	@JsOverlay
	public static void find(String[] fields, Function<Void, Contact[]> success, Function<Void, ContactError> error, ContactOptions contactOptions) {
